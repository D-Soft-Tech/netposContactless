...
class ContactlessRegViewModel @Inject constructor(
    ...
    fun registerExistingAccount(accountNumber: ExistingAccountRegisterRequest, bank: String) {
        _existingRegRequestResponse.postValue(Resource.loading(null))
        disposable.add(
            contactlessRegRepo.registerExistingAccount(
                accountNumber,
                bank,
                "7D66B7F7-222B-41CC-A868-185F3A86313F"
